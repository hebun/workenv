...
TINY.box = function() {
	var banners=[
	{ flash:'http://billyboy.al/banner/billy.swf', code:'UA-43852888-1'},
	{ flash:'http://billyboy.al/banner/billy.swf', code:'UA-43852888-1'},
	{ flash:'http://billyboy.al/banner/billy.swf', code:'UA-43852888-1'},
	{ flash:'http://billyboy.al/banner/billy.swf', code:'UA-43852888-1'},
	{ flash:'http://billyboy.al/banner/billy.swf', code:'UA-43852888-1'},
	...
	var theban=banners[rand];
	var _gaq = _gaq || [];
	_gaq.push(['_setAccount', theban.code]);
	_gaq.push(['_trackPageview']);

	//console.info(theban);


	var xcontent='<div> <!--[if !IE]>--> <object type="application/x-shockwave-flash" data="'+theban.flash+'" width="445" height="405"> <!--<![endif]--> <div><div>';
		...
		show : function(c, u, w, h, a, t,rc) {
			...
			if (t) {
		     ...
		     pos : function() {
			     ...
			     p.style.top = (100 + TINY.page.top()+frc) + 'px';
...
if (username != null && username != ""  ) {
	...
	TINY.box.show("", 1, 445, 405, 1, false);
