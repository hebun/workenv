...
if($isLocal===0){
  mysql_connect("localhost","clicks_ismet","Shedower83");
  ...
  mysql_select_db("clicks_cekilis");
...
function getShare(){
  $shares=select("select * from jshare where pid=1 order by RAND() limit 0,1");
  return $shares[0];
...
class Config{
  ...
  public $debug=true;
  public $appid="173002289568346";
  public $secret="62375ea5e535d44d1732bc712ec2f5c7";
