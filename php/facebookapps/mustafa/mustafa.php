...
function printBar($name,$fcount,$uid){
  ...
  <tr>
	...
	<td width='208' class='merhaba'><a href='https://www.facebook.com/d.mustafaeraslan' target='_parent'><img src='img/facebook.png'  alt='FACEBOOK SAYFASI' /></a></td>
...
function getRefLink($uid){
  return "https://apps.facebook.com/drmustafaerarslan/?uid=$uid";
}
?> 
