...
//burdan
	   ...
	   new site("http://form.jotformpro.com/form/23475787120962",99),
	   new site("http://form.jotformpro.com/form/23475787120962",1)
...
$acode=selectOne("publisher","acode","id",$_GET["pid"]);
	...
	echo '<iframe scrolling="no"  width="300" height="250" frameborder="no" src="'.$theSite.'"></iframe>';
?>
<script type="text/javascript">
