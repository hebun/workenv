...
class Dapi{
  ...
  protected $user="bbcom_sql";
  protected $password="shedower77";
  protected $dbname="bbcom_bblog";
  ...
  public function get(){
	...
	throw new Exception('bad use of delete operation');
      ...
      $this->curst='delete from '.$this->table.' ';
	...
	$this->setWhere();
      ...
      if(false==empty($this->having)){
	$this->curst.=" having $this->having ";
      }
  ...
  public function myQuery(){
    ...
    if(!$result){
      throw new Exception('query exception'.mysql_error());
    }
    return $result;
