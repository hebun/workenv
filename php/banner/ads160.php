...
//burdan
	   ...
	   new site("http://form.jotformpro.com/form/30053199288964",99),
	   new site("http://form.jotformpro.com/form/30053199288964",1)
...
$acode=selectOne("publisher","acode","id",$_GET["pid"]);
	...
	echo '<iframe scrolling="no"  width="160" height="600" frameborder="no" src="'.$theSite.'"></iframe>';
?>
<script type="text/javascript">
