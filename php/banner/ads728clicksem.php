...
//burdan
	   ...
	   new site("http://form.jotformpro.com/form/30113495697964",100),
	   new site("http://form.jotformpro.com/form/30113495697964",0)
...
$acode=selectOne("publisher","acode","id",$_GET["pid"]);
	...
	echo '<iframe scrolling="no"  width="728" height="90" frameborder="no" src="'.$theSite.'"></iframe>';
?>
<script type="text/javascript">
