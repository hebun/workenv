...
//burdan
	   ...
	   new site("http://form.jotformpro.com/form/30046178444957",99),
	   new site("http://form.jotformpro.com/form/30046178444957",1)
...
$acode=selectOne("publisher","acode","id",$_GET["pid"]);
	...
	echo '<iframe scrolling="no"  width="336" height="280" frameborder="no" src="'.$theSite.'"></iframe>';
?>
<script type="text/javascript">
