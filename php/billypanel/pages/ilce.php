...
##  *** put a primary key on the first place 
  $sql = "SELECT ilc.id as id,
  iname,ilname 
    FROM "._DB_PREFIX."ilce as ilc inner join il as i on i.id=ilc.ilId";         
...
##  *** set printing option: true(default) or false 
 ...
 $users=array();
  ...
  while($row=$dbx->fetchAssoc()){
	$users[$row["id"]]=$row["iname"]; 
  
  }
  }
 $vm_colimns = array(
    "ilname"              =>array("header"=>"İlçe İsmi", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
	"iname"         =>array("header"=>"İl",  "type"=>"label",      "req_type"=>"st", "width"=>"300px", "wrap"=>"nowrap","title"=>"", "readonly"=>false, "maxlength"=>"-1", "default"=>"0", "unique"=>false, "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "source"=>$users, "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "multiple"=>false, "multiple_size"=>"4"),
 );
...
##  *** set add/edit mode table properties
 ...
 $em_columns = array( 
    "ilname"              =>array("header"=>"İlçe İsmi", "type"=>"textbox",   "req_type"=>"rt", "width"=>"210px", "title"=>"İ", "readonly"=>false, "maxlength"=>"-1", "default"=>"", "unique"=>false, "unique_condition"=>"", "visible"=>"true", "on_js_event"=>""),    
	"ilId"         =>array("header"=>"İl",  "type"=>"enum",      "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>false, "maxlength"=>"-1", "default"=>"", "unique"=>false, "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "source"=>$users, "view_type"=>"dropdownlist", "radiobuttons_alignment"=>"horizontal|vertical", "multiple"=>false, "multiple_size"=>"4"), 
 );
