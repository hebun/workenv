...
##  *** set printing option: true(default) or false 
 ...
 $vm_colimns = array(
    "iname"              =>array("header"=>"İl  İsmi", "type"=>"label",      "align"=>"left", "width"=>"", "wrap"=>"nowrap", "text_length"=>"-1", "tooltip"=>false, "tooltip_type"=>"floating|simple", "case"=>"normal|upper|lower", "summarize"=>"true|false", "sort_by"=>"", "visible"=>"true", "on_js_event"=>""),
...
##  *** set add/edit mode table properties
 ...
 $em_columns = array( 
    "iname"              =>array("header"=>"İl İsmi", "type"=>"textbox",   "req_type"=>"rt", "width"=>"210px", "title"=>"İ", "readonly"=>false, "maxlength"=>"-1", "default"=>"", "unique"=>false, "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"")    
