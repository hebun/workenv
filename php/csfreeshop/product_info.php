...
?>      
    ...
    $(function(){
	var myWidth = <?php echo (($pi_counter > 1) ? '64' : '0'); ?>;
...
<?php
    ...
    if ($product_info['products_date_available'] > strftime("%d %B %Y, %A %H:%M:%S",date('Y-m-d H:i:s'))) {
?>
...
?>
	<div class="">
  	<div class="box_wrapper">
  		<h1><div class="title-icon"></div>Tags of product</h1>
      <div class="">
				<?php
                echo $tags;
        ?>
