...
"ui-datepicker-days-cell-over";this.regional=[];this.regional[""]={closeText:"Tamam",prevText:"Önceki",nextText:"Sonraki",currentText:"Bugün",monthNames:["Ocak","Subat","Mart","Nisan","Mayis","Haziran","Temmuz","Agustos","Eylül","Ekim","Kasim","Aralik"],monthNamesShort:['Ock','Sub','Mar','Nis','May','Haz','Tem','Agu','Eyl','Eki','Kas','Ara'],dayNames:["Pazar","Pazartesi","Sali","Çarsamba","Persembe","Cuma","Cumartesi"],dayNamesShort:["Paz","Pzt","Sal","Çrs","Prs","Cum","Cts"],dayNamesMin:["Pa","Pz","Sa","Çr","Pr","Cu","Ct"],weekHeader:"Wk",dateFormat:"aa/gg/yy",firstDay:0,isRTL:false,showMonthAfterYear:false,yearSuffix:""};this._defaults={showOn:"focus",showAnim:"fadeIn",showOptions:{},defaultDate:null,appendText:"",buttonText:"...",buttonImage:"",buttonImageOnly:false,hideIfNoPrevNext:false,navigationAsDateFormat:false,gotoCurrent:false,changeMonth:false,changeYear:false,yearRange:"c-10:c+10",showOtherMonths:false,selectOtherMonths:false,showWeek:false,calculateWeek:this.iso8601Week,shortYearCutoff:"+10",
