...
?>
 ...
 var t='<?php echo $tags?>';
           ...
           <tr>
                ...
                <tr>
                    <td class="main" ><strong>*</strong>Ingrese los tags (palabras claves del producto) seguidos de una coma Ejm: Azul,Grande,...</td>
                </tr>
        </table></td>
      </form></tr>
<?php
...
<?php
  ...
  switch ($action) {
    case 'delete':
      ...
      $contents[] = array('text' => 'Se borraran todos los tags asociados a este producto');
    ...
    default:
      if (is_object($sInfo)) {
        ...
        $contents[] = array('text' => '<br />Fecha de Adición ' . tep_date_short($sInfo->products_date_added));
