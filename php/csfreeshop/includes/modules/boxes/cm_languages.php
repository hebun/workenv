  ...
  class cm_languages {
    ...
    function cm_languages() {
      ...
      if ( defined('MODULE_BOXES_LANGUAGES_HEADER_FOOTER_STATUS') ) {
        ...
        $this->group = ((MODULE_BOXES_LANGUAGES_HEADER_FOOTER_CONTENT_PLACEMENT == 'Header Block') ? 'boxes_header' : 'boxes_footer');	
      }
    }
