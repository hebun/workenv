...
// *************************************
			if	(IMG_HOVER_EFFECT == 'style-1')	{
				$img_effect = 'first';
				$img_effect_width = PRODS_BLOCK_NEW_PRODUCT_WIDTH;	
			}
...
// *************************************
	...
	//  $p_desc = ''.substr(strip_tags($product['products_description']), 0, MAX_DESCR_1).' ...';
	  ...
	  $p_desc =  mb_substr(strip_tags($product['products_description']), 0, MAX_DESCR_NEW_PRODUCTS_MODUL, 'UTF-8').'...';
...
// *************************************
    ...
    $new_prods_content .= '<li style="width:'.PRODS_BLOCK_NEW_PRODUCT_WIDTH.'px;" class="wrapper_prods equal-height_new_products_block hover">'.
				  ...
				  '<div class="border_prods">'. "\n".
					''. "\n".
					'<div class="pic_padd wrapper_pic_div" style="width:'.(NEW_PRODS_MODUL_IMAGE_WIDTH + PIC_MARG_W).'px;height:'.(NEW_PRODS_MODUL_IMAGE_HEIGHT + PIC_MARG_H).'px;">'.$p_pic.''.tep_draw_prod_new_modul_pic_top().''.tep_draw_prod_new_modul_pic_bottom().'</a></div>'. "\n". //
          ''. "\n".
