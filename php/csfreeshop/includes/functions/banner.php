...
// Display a banner from the specified group or banner id ($identifier)
  function tep_display_banner($action, $identifier) {
    ...
    if (tep_not_null($banner['banners_html_text'])) {
      ...
      $banner_string = '<a href="' . tep_href_link(FILENAME_REDIRECT, 'action=banner&goto=' . $banner['banners_id']) . '" target="'.$banner_target.'">'. tep_image(DIR_WS_IMAGES . $banner['banners_image'], $banner['banners_title'], '', '', $banner['banners_target']) . '</a>';
    }
