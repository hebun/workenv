...
// *************************************
			if	(IMG_HOVER_EFFECT == 'style-1')	{
				$img_effect = 'first';
				$img_effect_width = PRODS_BLOCK_SPECIALS_WIDTH;	
			}
...
// *************************************
    ...
    $specials_prods_content .= '<li style="width:' . PRODS_BLOCK_SPECIALS_WIDTH . 'px;" class="wrapper_prods equal-height3 hover">'. "\n".
				  '<div class="border_prods">'. "\n".
					...
					'<div class="border_prods">'. "\n".
					''. "\n".
					'<div class="pic_padd wrapper_pic_div" style="width:'.(SPECIAL_IMAGE_WIDTH + PIC_MARG_W).'px;height:'.(SPECIAL_IMAGE_HEIGHT + PIC_MARG_H).'px;">'.$p_pic.''.tep_draw_prod_new_modul_pic_top().''.tep_draw_prod_new_modul_pic_bottom().'</a></div>'. "\n". //
          ''. "\n".
