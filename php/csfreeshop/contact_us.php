...
?>
 ...
 <tr> <td width="333" height="152" align="left" valign="top" class="main"><p>
    <strong>Adres:</strong> <br>
ClickSem Ltd. Maslak Meydan Sokak No.1 Beybi Giz Plaza Kat.26 Ofis.2620 Þiþli / Ýstanbul<br><br>
<strong>Aþaðýdaki formu doldurarak da bize ulaþabilirsiniz.</strong> <br>
</td> </tr>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr>
               ...
               <tr>
                ...
                <td class="fieldKey"><?php echo Telefon; ?></td>

                <td class="fieldValue"><?php echo tep_draw_input_field('phone', '', 'class="input"'); ?></td>
