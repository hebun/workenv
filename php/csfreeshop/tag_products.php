...
*/
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_TAG_PRODUCTS);
	$current_page = FILENAME_TAG_PRODUCTS;
...
<?php
	  ...
	  $tag_prods_content = '<div class="padding un prods_table">';
    ...
    $tag_prods_content .= '<div align="center" valign="top" class="contentInfoBlock hover">
