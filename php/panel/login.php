...
<tr>
	...
	<tbody>
	<tr>
	    <td class="tcat" colspan="2" align="center"><strong>Giriş yapmak için kullanıcı adınızı ve şifrenizi giriniz.</strong></td></tr>
	<tr>
	    <td class="alt1">
		<div class="alt2 raised" align="center">
		<?php
		    if($msg == "1"){
			echo "<label class='msg_error'>Yanlış kullanıcı veya şifre!</label>";
		    }
		?>			
		<div align="left">
			...
			<tbody>
			<tr vAlign="top">
			    <td colSpan="2">Kullanıcı Adı<br><input type="text" class="bginput" size="50" maxsize="100" id="rt_admin_username" name="rt_admin_username" value="<?php echo $admin_username; ?>" title="Username"></td>
			</tr>
			<tr vAlign=top>
			    <td colSpan="2">Şifre<br><input type="password" class="bginput" size="50" maxsize="100" id="rt_admin_password" name="rt_admin_password" title="Password"></td>
			</tr>
			<tr>
			    ...
			    <td align="left" width="91%"><small><label>Beni hatırla </label></small></td>
			</tr>
			</tbody>
			</table>
		    </div>
		...
		<div style="MARGIN-TOP: 6px" align=center>
		    <input class="button" accessKey="s" type="submit" value="Giriş" onClick="rememberMe(); return onSubmitCheck(document.forms['frmLogin'], false,false);"> 
		</div>
	    </td>
	</tr>
	</tbody>
