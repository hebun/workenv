...
It's very easy to get started with ApPHP AdminPanel!!!

1. Installation:
   http://apphp.com/php-adminpanel/index.php?page=installation

2. Getting started:
   http://apphp.com/php-adminpanel/index.php?page=getting_started

-----------------------------------------------------------------------------------
For more information visit: 
	site 	http://apphp.com/php-adminpanel/index.php?page=examples
