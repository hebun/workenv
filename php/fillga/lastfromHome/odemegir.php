...
if(isset($_POST['submit'])){
	$user=$dapi->select("select kbakiye,kupontype from users where customerId=$_POST[account]")[0];
	...
	$dapi->insert("insert into muhasebe set customerId=$_POST[account],type='odeme',tutar=$_POST[bakiye],tarih='".date('Y-m-d H:i:s')."'");

	echo '<div style="padding-top:100px;">Odeme Eklendi. Pencereyi kapatin ve listeyi guncelleyin</div>';
