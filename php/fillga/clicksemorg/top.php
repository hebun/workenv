...
if(isset($_SESSION['type'])){
	...
	if($_SESSION['type']==1){
		echo ' 
			...
			<li class=" selected default" id="adminli"><a href="bayi.php" title="destek/yardım" rel="admin_upload">
			<span>Bayiler</span></a></li>';
	}
...
<?php
$dapi=new Dapi();
$userRow=$dapi->select("select * from users where customerId=$_SESSION[customerId]");
$userRow=$userRow[0];
