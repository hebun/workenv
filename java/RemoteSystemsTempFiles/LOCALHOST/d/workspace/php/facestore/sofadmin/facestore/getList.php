...
while ($row = mysql_fetch_assoc($res)) {
		...
		$table.="<td bgcolor='#ffffff' align=left><span class='imgname'>$row[name]<br><img width='134' ".
 "style='cursor:pointer;' onclick='popBigImg($row[id],$rc,this)' height='154' src='../../$row[img]'".
	        "/><br>$row[price] TL</span><br>";

	if($page->orderButton){
		$table.= " <input type='button' onclick='editProduct($row[id],this)' value='Düzenle' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		$table.= " <img src='img/hr.gif' width='16' style='cursor:pointer' height='16' alt='Sil' onclick='deleteProduct($row[id])' />"
			;
