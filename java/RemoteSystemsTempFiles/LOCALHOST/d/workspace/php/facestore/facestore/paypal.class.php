...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>Yönlendiriliyor...</title></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      echo "<center><h2>Lütfen bekleyin ödemenin işlenmesi için ";
      echo " paypal sitesine yönlendiriliyorsunuz.</h2></center>\n";
      ...
      echo "<center><br/><br/>Eğer 5 saniye içinde yönlendirilmezseniz  ";
      echo "...<br/><br/>\n";
