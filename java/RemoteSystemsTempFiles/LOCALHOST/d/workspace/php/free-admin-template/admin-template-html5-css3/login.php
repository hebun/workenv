...
<table border="0" cellpadding="0" cellspacing="0" width="650">
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFFF">
        <input type="text" id="txtKulad" name="txtKulad"  class="form_ana" /></td>
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFFF">
      <input type="text" id="txtSifre" name="txtSifre"   class="form_ana"/></td></td>
  ...
  <tr>
    ...
    <td>
        <input id="ImageButton1" type="image" border="0" style="height:26px;width:82px;border-width:0px;" src="images/adminlogin_r8_c3.jpg" name="ImageButton1"/></td>
